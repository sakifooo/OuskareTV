...
export default function Home() {
  ...
  const matches = [
    ...
    { teamA: "كندا", teamB: "جنوب افريقيا", scoreA: 0, scoreB: 0, time: "20:00", status: "live", channel: "beIN SPORTS MAX 2", commentator: "غير معروف", league: "كأس العالم", href: "/live/canada-vs-southafrica" },  
