...
export default function Home() {
  ...
  const matches = [
    { teamA: "النرويج", teamB: "فرنسا", scoreA: 4, scoreB: 1, time: "20:00", status: "finished", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/norway-vs-france" },
