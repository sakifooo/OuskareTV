...
export default function Home() {
  ...
  const matches = [
    { teamA: "سكتلندا", teamB: "هايتي", scoreA: 0, scoreB: 0, time: "02:00", status: "live", channel: "beIN SPORTS MAX 1", commentator: " غير معروف", league: "كأس العالم", href: "/live/scotland-vs-haiti" },
    { teamA: "استراليا", teamB: "تركيا", scoreA: 0, scoreB: 0, time: "05:00", status: "live", channel: "beIN SPORTS MAX 2", commentator: "غير معروف", league: "كأس العالم", href: "/live/turc-vs-australia" },
