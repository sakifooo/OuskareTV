...
export default function Home() {
  ...
  const matches = [
    ...
    { teamA: "رأس الاخضر ", teamB: "الارجنتين", scoreA: 0, scoreB: 0, time: "23:00", status: "live", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/capvers-vs-argentina" },
