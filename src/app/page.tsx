...
export default function Home() {
  ...
  const matches = [
    { teamA: "النرويج", teamB: "ساحل العاج", scoreA: 0, scoreB: 0, time: "18:00", status: "live", channel: "beIN SPORTS MAX 2", commentator: "غير معروف", league: "كأس العالم", href: "/live/cotedivoire-vs-norway" },  
