...
export default function Home() {
  ...
  const matches = [
    { teamA: "انجلترا", teamB: "الارجنتين ", scoreA: 0, scoreB: 0, time: "20:00", status: "upcoming", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: " نصف النهائي ", href: "/live/spain-vs-france" },  
