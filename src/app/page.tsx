...
export default function Home() {
  ...
  const matches = [
    { teamA: "الولايات المتحدة", teamB: "استراليا", scoreA: 2, scoreB: 0, time: "20:00", status: "live", channel: "beIN SPORTS HD1", commentator: "غير معروف", league: "كأس العالم", href: "/live/usa-vs-australia" },
