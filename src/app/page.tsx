...
export default function Home() {
  ...
  const matches = [
    { teamA: "سويسرا", teamB: "كندا", scoreA: 0, scoreB: 0, time: "20:00", status: "upcoming", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/swis-vs-canda" },
    { teamA: "البوسنة", teamB: "قطر", scoreA: 0, scoreB: 0, time: "20:00", status: "upcoming", channel: "beIN SPORTS MAX 2", commentator: "غير معروف", league: "كأس العالم", href: "/live/bosna-vs-qatar" },
    { teamA: "هايتي", teamB: "المغرب", scoreA: 0, scoreB: 0, time: "23:00", status: "upcoming", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/haiti-vs-maroc" },
    { teamA: "اسكتلندا", teamB: "البرازيل", scoreA: 0, scoreB: 0, time: "23:00", status: "upcoming", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/scotland-vs-brazil" },
