...
export default function Home() {
  ...
  const matches = [
    { teamA: "اسبانيا", teamB: "النمسا ", scoreA: 0, scoreB: 0, time: "20:00", status: "live", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/spain-vs-austria" }, 
