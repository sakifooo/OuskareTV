...
export default function Home() {
  ...
  const matches = [
    { teamA: "اسبانيا", teamB: "النمسا ", scoreA: 0, scoreB: 0, time: "20:00", status: "upcoming", channel: "beIN SPORTS MAX 2", commentator: "غير معروف", league: "كأس العالم", href: "/live/spain-vs-austria" }, 
    { teamA: "البرتغال ", teamB: "كرواتيا", scoreA: 0, scoreB: 0, time: "00:00", status: "upcoming", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/portugal-vs-croitia" },
