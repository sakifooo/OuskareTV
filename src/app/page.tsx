...
export default function Home() {
  ...
  const matches = [
    { teamA: "اسبانيا", teamB: "بلجيكا ", scoreA: 0, scoreB: 0, time: "20:00", status: "live", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: " ربع النهائي", href: "/live/spain-vs-belgique" }, 
