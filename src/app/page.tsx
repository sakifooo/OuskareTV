...
export default function Home() {
  ...
  const matches = [
    { teamA: "فرنسا", teamB: "المغرب ", scoreA: 0, scoreB: 0, time: "21:00", status: "upcoming", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: " ربع النهائي", href: "/live/france-vs-maroc" }, 
