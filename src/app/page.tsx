...
export default function Home() {
  ...
  const matches = [
    { teamA: "العراق", teamB: "النرويج", scoreA: 1, scoreB: 2, time: "23:00", status: "live", channel: "beIN SPORTS MAX 2", commentator: "غير معروف", league: "كأس العالم", href: "/live/norway-vs-iraq" },
