...
export default function Home() {
  ...
  const matches = [
    { teamA: "الإكوادور", teamB: "ألمانيا", scoreA: 2, scoreB: 1, time: "21:00", status: "live", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/ecwador-vs-germany" },
    { teamA: "كوراساو", teamB: "كوت ديفوار", scoreA: 0, scoreB: 2, time: "21:00", status: "live", channel: "beIN SPORTS MAX 2", commentator: "غير معروف", league: "كأس العالم", href: "/live/corasaw-vs-cotedivoire" },
