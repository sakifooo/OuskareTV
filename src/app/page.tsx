...
export default function Home() {
  ...
  const matches = [
    { teamA: "انجلترا", teamB: "فرنسا ", scoreA: 0, scoreB: 0, time: "20:00", status: "upciming", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "  الترتيب ", href: "/live/spain-vs-france" },  
