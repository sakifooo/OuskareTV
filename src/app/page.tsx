...
export default function Home() {
  ...
  const matches = [
    { teamA: "هولندا", teamB: "اليابان", scoreA: 0, scoreB: 0, time: "21:00", status: "upcoming", channel: "beIN SPORTS MAX 2", commentator: "غير معروف", league: "كأس العالم", href: "/live/holand-vs-japan" },
    { teamA: "المانيا ", teamB: "كوراساو ", scoreA: 7, scoreB: 1, itime: "18:00 ", status: "finished", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/germany-vs-corasaw" },
