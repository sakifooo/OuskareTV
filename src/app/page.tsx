...
export default function Home() {
  ...
  const matches = [
    ...
    { teamA: "كندا", teamB: "قطر", scoreA: 6, scoreB: 0, time: "23:00", status: "live", channel: "beIN SPORTS HD1", commentator: "غير معروف", league: "كأس العالم", href: "/live/qatar-vs-canada" },
