...
export default function Home() {
  ...
  const matches = [
    { teamA: "مصر", teamB: "الارجنتين ", scoreA: 0, scoreB: 0, time: "17:00", status: "upcoming", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/egypt-vs-argentina" }, 
    { teamA: " سويسرا", teamB: "كلومبيا ", scoreA: 0, scoreB: 0, time: "21:00", status: "upcoming", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/swis-vs-colombia" },
