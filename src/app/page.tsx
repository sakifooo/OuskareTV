...
export default function Home() {
  ...
  const matches = [
    { teamA: "تشيكيا", teamB: "جنوب افريقيا", scoreA: 0, scoreB: 0, time: "17:00", status: "live", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/check-vs-southafrica" },
