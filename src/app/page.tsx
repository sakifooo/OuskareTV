...
export default function Home() {
  ...
  const matches = [
    { teamA: "فرنسا", teamB: "السنغال", scoreA: 3, scoreB: 1, time: "20:00", status: "live", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/france-vs-senigal" },
