...
export default function Home() {
  ...
  const matches = [
    { teamA: "البرتغال", teamB: "اسبانيا ", scoreA: 0, scoreB: 0, time: "20:00", status: "upcoming", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/portugal-vs-spain" }, 
    { teamA: " بلجيكا", teamB: "الولايات المتحدة", scoreA: 0, scoreB: 0, time: "01:00", status: "upcoming", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/belgique-vs-usa" },
