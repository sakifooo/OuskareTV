...
export default function Home() {
  ...
  const matches = [
    ...
    { teamA: "النرويج", teamB: "السنغال ", scoreA: 0, scoreB: 0, time: "01:00", status: "upcoming", channel: "beIN SPORTS MAX 2", commentator: "غير معروف", league: "كأس العالم", href: "/live/norway-vs-senigal" },
