...
export default function Home() {
  ...
  const matches = [
    { teamA: "المغرب", teamB: "البرازيل", scoreA: 0, scoreB: 0, time: "23:00", status: "live", channel: "beIN SPORTS MAX 2", commentator: " جواد بادة", league: "كأس العالم", href: "/live/maroc-vs-brazil" },
