...
export default function Home() {
  ...
  const matches = [
    { teamA: "هلندا", teamB: "المغرب", scoreA: 0, scoreB: 0, time: "02:00", status: "live", channel: "beIN SPORTS MAX 2", commentator: "غير معروف", league: "كأس العالم", href: "/live/maroc-vs-holand" },  
