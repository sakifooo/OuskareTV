...
export default function Home() {
  ...
  const matches = [
    { teamA: "النرويج", teamB: "فرنسا", scoreA: 0, scoreB: 0, time: "20:00", status: "finished", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/norway-vs-france" },
    { teamA: "العراق", teamB: "السنغال", scoreA: 0, scoreB: 0, time: "20:00", status: "finished", channel: "beIN SPORTS MAX 2", commentator: "غير معروف", league: "كأس العالم", href: "/live/senigal-vs-iraq" },
