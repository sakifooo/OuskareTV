...
export default function Home() {
  ...
  const matches = [
    ...
    { teamA: "فرنسا", teamB: "العراق", scoreA: 1, mscoreB: 0, time: "22:00", status: "live", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/france-vs-iraq" },
    { teamA: "النرويج", teamB: "السنغال ", scoreA: 0, scoreB: 0, time: "01:00", status: "live", channel: "beIN SPORTS MAX 2", commentator: "غير معروف", league: "كأس العالم", href: "/live/norway-vs-senigal" },
