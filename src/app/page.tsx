...
export default function Home() {
  ...
  const matches = [
    { teamA: "هولندا", teamB: "السويد", scoreA: 5, scoreB: 1, time: "18:00", status: "live", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/holand-vs-sweden" },
