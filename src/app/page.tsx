...
export default function Home() {
  ...
  const matches = [
    { teamA: "النرويج", teamB: "ساحل العاج", scoreA: 0, scoreB: 0, time: "18:00", status: "upcoming", channel: "beIN SPORTS MAX 2", commentator: "غير معروف", league: "كأس العالم", href: "/live/cotedivoire-vs-norway" },  
    { teamA: "فرنسا ", teamB: "السويد", scoreA: 0, scoreB: 0, time: "22:00", status: "upcoming", channel: "beIN SPORTS MAX 1", commentator: "غير معروف", league: "كأس العالم", href: "/live/france-vs-swed" },
